...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-neuropax-event-landing.js
  var import_neuropax_event_landing_exports = {};
  __export(import_neuropax_event_landing_exports, {
    default: () => import_neuropax_event_landing_default
  });
  ...
  var import_neuropax_event_landing_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_neuropax_event_landing_exports);
})();
